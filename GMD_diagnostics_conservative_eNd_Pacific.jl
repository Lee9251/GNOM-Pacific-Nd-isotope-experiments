...
function plot_conservative_ε!(fig)
    ...
    opts = (mask=PAC, nan_color=nan_color, extendhigh=:auto, extendlow=:auto, linewidth=0.5)
    εopts = (colormap=εcmap, levels=εlevels, colorrange=(-12,0))
    δεopts = (colormap=:viridis, levels=δεlevels2, colorrange=(-5,1))
